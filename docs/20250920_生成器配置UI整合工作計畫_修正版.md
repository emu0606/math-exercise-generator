...
**計畫狀態**: 📋 **修正版完成** - 基於深度討論的務實方案
**核心策略**: 最小風險 + 生成器自描述 + 階段性實施
**預計時間**: 100分鐘 (後端40分鐘 + 生成器20分鐘 + UI25分鐘 + 測試15分鐘)
**風險等級**: 低 (避開CategoryWidget核心邏輯修改)