...
\begin{answerRow}
  \numberedAnswerLine{1}{$2\sqrt{6} + \sqrt{2}$}
  \numberedAnswerLine{2}{$\sqrt{23} + 3\sqrt{2}$}
  \numberedAnswerLine{3}{$\sqrt{13} - 1$}
\end{answerRow}
\begin{answerRow}
  \numberedAnswerLine{4}{$\sqrt{22} - \sqrt{3}$}
  \numberedAnswerLine{5}{$3 - \sqrt{5}$}
  \numberedAnswerLine{6}{$\sqrt{21} - \sqrt{19}$}
\end{answerRow}
\begin{answerRow}
  \numberedAnswerLine{7}{$\sqrt{13} + \sqrt{10}$}
  \numberedAnswerLine{8}{$\sqrt{13} - 2\sqrt{2}$}
  \numberedAnswerLine{9}{$\sqrt{19} + \sqrt{14}$}
\end{answerRow}
\begin{answerRow}
  \numberedAnswerLine{10}{$\sqrt{21} + \sqrt{3}$}
  \numberedAnswerLine{11}{$4 + \sqrt{7}$}
  \numberedAnswerLine{12}{$\sqrt{21} + 3$}
\end{answerRow}
\begin{answerRow}
  \numberedAnswerLine{13}{$\sqrt{13} + 2$}
  \numberedAnswerLine{14}{$2\sqrt{3} + \sqrt{10}$}
\end{answerRow}
\vfill
\begin{center}
