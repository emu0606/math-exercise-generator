...
\begin{tikzpicture}
  ...
  \node[anchor=north west, text width=3.775cm, inner sep=0.2cm] at ({ 0.0+0.1 }, { 0.0+-0.5 }) {$\sin(45^\circ) = $};
  ...
  \node[anchor=north west, text width=3.775cm, inner sep=0.2cm] at ({ 4.475+0.1 }, { 0.0+-0.5 }) {$\cos(315^\circ) = $};
  ...
  \node[anchor=north west, text width=3.775cm, inner sep=0.2cm] at ({ 8.95+0.1 }, { 0.0+-0.5 }) {$\tan^{-1}(-1) = $};
  ...
  \node[anchor=north west, text width=3.775cm, inner sep=0.2cm] at ({ 13.424999999999999+0.1 }, { 0.0+-0.5 }) {$\sin^{-1}(-1) = $};
  ...
  \node[anchor=north west, text width=3.775cm, inner sep=0.2cm] at ({ 0.0+0.1 }, { -2.957+-0.5 }) {$\cos^{-1}(0) = $};

  % 題目 6
  \draw[rounded corners=3pt, thick] (4.475, -2.957) rectangle (12.924999999999999, -5.414);
  \node[overlay, anchor=north west, inner sep=0] at ({ 4.475 }, { -2.957 }) {\qnumShadowBox{6}};
  \node[anchor=north west, text width=8.25cm, inner sep=0.2cm] at ({ 4.475+0.1 }, { -2.957+-0.5 }) {以 $0\sim90^\circ$ 表示 $\tan(-80^\circ)$};

  % 題目 7
  \draw[rounded corners=3pt, thick] (0.0, -5.914) rectangle (8.45, -8.370999999999999);
  \node[overlay, anchor=north west, inner sep=0] at ({ 0.0 }, { -5.914 }) {\qnumShadowBox{7}};
  \node[anchor=north west, text width=8.25cm, inner sep=0.2cm] at ({ 0.0+0.1 }, { -5.914+-0.5 }) {以 $0\sim90^\circ$ 表示 $\tan(250^\circ)$};

  % 題目 8
  \draw[rounded corners=3pt, thick] (8.95, -5.914) rectangle (17.4, -8.370999999999999);
  \node[overlay, anchor=north west, inner sep=0] at ({ 8.95 }, { -5.914 }) {\qnumShadowBox{8}};
  \node[anchor=north west, text width=8.25cm, inner sep=0.2cm] at ({ 8.95+0.1 }, { -5.914+-0.5 }) {化簡：$\sqrt{28 + 2\sqrt{187}}$};

  % 題目 9
  \draw[rounded corners=3pt, thick] (0.0, -8.870999999999999) rectangle (8.45, -11.328);
  \node[overlay, anchor=north west, inner sep=0] at ({ 0.0 }, { -8.870999999999999 }) {\qnumShadowBox{9}};
  \node[anchor=north west, text width=8.25cm, inner sep=0.2cm] at ({ 0.0+0.1 }, { -8.870999999999999+-0.5 }) {化簡：$\sqrt{19 + 6\sqrt{10}}$};

  % 題目 10
  \draw[rounded corners=3pt, thick] (8.95, -8.870999999999999) rectangle (17.4, -11.328);
  \node[overlay, anchor=north west, inner sep=0] at ({ 8.95 }, { -8.870999999999999 }) {\qnumShadowBox{10}};
  \node[anchor=north west, text width=8.25cm, inner sep=0.2cm] at ({ 8.95+0.1 }, { -8.870999999999999+-0.5 }) {化簡：$\sqrt{35 + 10\sqrt{10}}$};
