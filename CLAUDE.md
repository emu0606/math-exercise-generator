...
**範例**:
- `20251023_二次函數優化計畫_研擬中.md`
- `20251023_UI組件重構方案_執行中.md`
- `20251023_性能優化實施策略_已完成.md`
...
完整的開發指南體系請參考：[docs/開發指南索引.md](docs/開發指南索引.md)

**快速連結**:
- [生成器開發指南.md](docs/生成器開發指南.md) ⭐ **最重要**
- [配置Schema規範.md](docs/配置Schema規範.md) - 添加UI配置時使用
- [available_figures.md](docs/available_figures.md) - 查看可用圖形

**典範生成器參考**:
- `generators/trigonometry/InverseTrigonometricFunctionGenerator.py` - 簡潔型（推薦入門）
